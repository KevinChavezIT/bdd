...
select count(*) as "transacciones_credito" from transacciones where tipo='C'

select numero_cuenta , round(AVG(cast (monto as decimal)),'2') as 
"monto_promedio" from transacciones group by numero_cuenta
