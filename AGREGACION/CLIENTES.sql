...
select cl.cedula , cl.nombre, count(co.monto) from compras co,clientes cl
where cl.cedula = co.cedula
group by cl.cedula

select fecha_compra,count (*)  AS "Total_compras" from compras
where fecha_compra = '29/10/2022'
